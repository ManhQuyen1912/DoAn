        ...
        GridLayout {
            ...
            CameraButton {
                    ...
                    onClicked: {
                        ...
                        // sleep 0.5s
                        var delayTimer = Qt.createQmlObject('import QtQuick 2.15; Timer { }', buttonsColumn);
                        delayTimer.interval = 500; // 0.5 seconds
                        delayTimer.repeat = false;
                        delayTimer.triggered.connect(function() {
                            imageUploader.uploadCapturedImage(imagePath);
                        });
                        delayTimer.start();
                    }
                }
